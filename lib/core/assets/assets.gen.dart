...
class $AssetsImagesPngGen {
  ...
  /// File path: assets/images/png/example.png
  AssetGenImage get example =>
      const AssetGenImage('assets/images/png/example.png');
...
class $AssetsImagesSvgGen {
  ...
  /// File path: assets/images/svg/example.svg
  SvgGenImage get example => const SvgGenImage('assets/images/svg/example.svg');
